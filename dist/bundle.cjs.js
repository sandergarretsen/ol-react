  ...
  createClass(Map, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.Children.toArray(this.props.children).map(function (child) {
...
var Feature = function (_Component) {
  ...
  createClass(Feature, [{
    ...
    value: function render() {
      ...
      return React__default.Children.toArray(this.props.children).map(function (child) {
        return React__default.cloneElement(child, {
...
exports.BingMapsSource = BingMaps;
exports.VectorSource = Vector$1;
